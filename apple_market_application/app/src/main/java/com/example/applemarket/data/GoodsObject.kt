...
object GoodsObject {
    val goodsList = listOf(
        ...
        GoodsData(
            ...
            seller = "똑태현",
            price = 190000,
            goodsImage = R.drawable.sample10,
            chatCnt = 40,
            likeCnt = 6
        ),
    )
